...
describe('test setDoc', () => {
	...
	it('test wrong type', () => {
		...
		;() =>
			setDoc(userRef.doc('FirelordTest', '123'), {
				beenTo: [],
				// @ts-expect-error
				name: true,
				// @ts-expect-error
	...
	it('test functionality', async () => {
		await writeThenReadTest(async data => {
			const ref = userRef.doc('FirelordTest', 'setDocTestCase')
	...
	it('test merge false functionality', async () => {
		await writeThenReadTest(async data => {
			const ref = userRef.doc('FirelordTest', 'setDocTestCaseMergeFalse')
	...
	it('test merge true functionality', async () => {
		const ref = userRef.doc('FirelordTest', 'setDocTestCaseMergeTrue')
	...
	it('test merge field functionality', async () => {
		const ref = userRef.doc('FirelordTest', 'setDocTestCaseMergeField')
		const data = generateRandomData()
		await setDoc(ref, data)
	...
	it('test merge field empty functionality', async () => {
		const ref = userRef.doc('FirelordTest', 'setDocTestCaseMergeFieldEmpty')
		const data = generateRandomData()
		await setDoc(ref, data)
