...
describe('test updateNoFlatten batch', () => {
	it('test whether the return type is correct', () => {
		type A = ReturnType<typeof writeBatch>['updateNoFlatten']
		type B = WriteBatchUpdateNoFlatten
		IsTrue<IsSame<A, B>>()
	})
	it('test full updateNoFlatten functionality', async () => {
